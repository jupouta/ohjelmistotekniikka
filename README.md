...
### Ohjelman ajaminen
Ohjelma toimii ajamalla `poetry run invoke start` havikkisovellus-kansiossa. Ohjelman ajamiseen voi käyttää myös virtuaaliympäristöä komennolla `poetry shell`.
